...
const TechStack = () => {
    return (
        <section id="tech-stack" className="py-5">
            <h1 className="px-5 text-2xl border-y text-neutral-700 dark:text-neutral-100 font-bold py-2">
                Tech Stack
            </h1>
            <div className="w-full">
                <div className="grid grid-cols-1 md:grid-cols-[1fr_3fr] border-b">
                    ...
                    <div className="flex flex-wrap gap-3 px-5 py-3">
                        <div className="flex gap-1 items-center border bg-neutral-700 px-2 py-1 rounded-sm text-white dark:text-neutral-200">
                            <svg
                            ...
                            <span className="text-xs text-white dark:text-neutral-200 font-light">
                                TypeScript
                            </span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_3fr] border-b">
                    ...
                    <div className="flex flex-wrap space-x-3 gap-y-2 px-5 py-3">
                        ...
                        <div className="flex gap-1.5 items-center border bg-neutral-700 px-2 py-1 rounded-sm text-neutral-300">
