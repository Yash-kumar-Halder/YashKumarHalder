          ...
          <div className="w-full h-full px-8 py-2 pb-5 flex flex-col items-start justify-start bg-gray-600/20 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted hover:scale-[1.02] transition-all duration-200 ">
            ...
            <div className="w-full h-full">
              ...
              <p className="text-xs pb-4 mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400 ">
                I am a dedicated Full Stack Web Developer with a strong grasp of
                HTML, CSS, JavaScript, React, and backend technologies. In
                January 2025, I completed a one-month Full Stack Web Development
                internship with PHP at Databits Technologia, where I gained
                practical experience in building dynamic and responsive web
                applications. I am passionate about writing clean, efficient
                code and continuously improving my skills to deliver impactful
                digital solutions.
              </p>
            </div>
          </div>
          <div className="h-full px-8 py-2 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted bg-gray-600/20 hover:scale-[1.02] transition-all duration-200">
            ...
            <div className="w-full h-full">
              ...
              <p className="text-xs pb-4  mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400  ">
                ...
                Technology, which I began in September 2023 and am expected to
                complete in 2026. I am in my final year (5th semester) with a
                current average GPA of 7.65. My studies focus on building a
                strong foundation in programming, web development, and
                problem-solving, preparing me for a career in the tech industry.
              </p>
            </div>
          </div>
        </div>
        <div className="w-[90%] md:w-[80%] mt-4 mx-auto grid grid-cols-1 md:grid-cols-[1fr_2fr_1.2fr] direction-rtl items-center gap-4">
          ...
          <div className="order-2 sm:order-2 h-full px-8 py-6 pb-4 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted bg-gray-600/20 flex flex-col items-start justify-end relative overflow-hidden hover:scale-[1.02] transition-all duration-200 ">
            ...
            <div className="w-full  flex items-center justify-between">
              ...
              >
                work <span className="text-gradient-cyan-purple">together</span>
              </h2>
              <Link
                href="#contact"
