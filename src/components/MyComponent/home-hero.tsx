    ...
    <>
      <div className="md:min-h-screen lg:pl-28 flex items-end md:items-center justify-center py-6">
        <div className="md:h-full flex flex-col items-center md:items-start justify-end md:justify-center">
          ...
          >
            <span className="text-neutral-700 dark:text-neutral-300">Hi, </span>{" "}
          ...
          <div className="w-[90%] md:w-[50%] h-12 md:mt-4 rounded-sm flex items-center justify-center md:justify-around gap-2 md:gap-3 ">
            <Link
              ...
              className="flex items-center gap-1 bg-gray-600/20 border border-transparent hover:border-gray-500 px-3 md:px-4 py-0.5 md:py-2 rounded-sm hover:scale-105 cursor-pointer transition-all duration-150"
            >
              <svg
              ...
              <p className="text-[10px] md:text-base">LINKEDIN</p>
            </Link>
            <Link
            aria-label="Github"
            ...
            <Link
            aria-label="Leetcode"
              href="https://leetcode.com/u/Yash_kumar321/"
              className="flex items-center gap-1 md:gap-3 bg-gray-600/20 border border-transparent hover:border-gray-500 px-3 md:px-4 py-1 md:py-2 rounded-sm hover:scale-105 cursor-pointer transition-all duration-150"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-[10px] md:text-base">LEETCODE</p>
            </Link>
          </div>
        </div>
      </div>
