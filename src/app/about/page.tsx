                  ...
                  <div className="w-full h-full px-8 py-2 md:pb-2 flex flex-col items-start justify-start bg-gray-600/20 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted hover:scale-[1.02] transition-all duration-200 ">
                      ...
                      <div className="w-full h-full">
                          ...
                          <span className="text-xs inline-block leading-[18px] pb-4  mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400 ">
                              Full Stack MERN Developer skilled in MongoDB,
                              Express.js, React.js, Node.js, and Next.js.
                              Experienced in building scalable, responsive, and
                              production-ready web applications with modern
                              authentication and REST API integration. Upcoming
                              Step Intern at{" "}
                                  <Link href="https://www.thoughtworks.com/" className="underline underline-offset-2 hover:text-blue-600 transition-colors duration-150">
                                      Thoughtworks
                                  </Link>
                  ...
                  <div className="w-full h-full px-8 py-2 pb-5 flex flex-col items-start justify-start bg-gray-600/20 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted hover:scale-[1.02] transition-all duration-200 ">
                      ...
                      <div className="w-full h-full">
                          ...
                          <p className="text-xs pb-4 mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400 ">
                              ...
                              strong grasp of HTML, CSS, JavaScript, React, and
                              backend technologies. In January 2025, I completed
                              a one-month Full Stack Web Development internship
                              with PHP at Databits Technologia, where I gained
                              practical experience in building dynamic and
                              responsive web applications. I am passionate about
                              writing clean, efficient code and continuously
                              improving my skills to deliver impactful digital
                              solutions.
                          </p>
                      </div>
                  </div>
                  <div className="h-full px-8 py-2 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted bg-gray-600/20 hover:scale-[1.02] transition-all duration-200">
                      ...
                      <div className="w-full h-full">
                          ...
                          <p className="text-xs pb-4  mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400  ">
                              ...
                              2023 and am expected to complete in 2026. I am in
                              my final year (5th semester) with a current
                              average GPA of 7.65. My studies focus on building
                              a strong foundation in programming, web
                              development, and problem-solving, preparing me for
              ...
              <div className="w-[90%] md:w-[80%] mt-4 mx-auto grid grid-cols-1 md:grid-cols-[1fr_2fr_1.2fr] direction-rtl items-center gap-4">
                  <div className="order-3 sm:order-1 about-card-bg-image h-full px-8 pt-8 pb-4 flex flex-col gap-5 items-start justify-start rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted hover:scale-[1.02] transition-all duration-200 ">
                      <div className="w-full h-full bg-linear-to-r from-[#b8b8b81c] to-[#00000083] border border-[#202020] rounded-3xl overflow-hidden flex items-center justify-center gap-6 px-5 hover:border-gray-700">
                          <Link
                              ...
                              className="w-[30%] bg-linear-120 from-[#6d6d6d4f] to-[#0000003d] border border-[#242424] flex items-center justify-center rounded-full aspect-square cursor-pointer hover:fill-amber-500 transition-all duration-150 hover:scale-105"
                          >
                              <Linkedin className="stroke-muted stroke-0 fill-muted dark:fill-muted-foreground" />
                          </Link>
                          <Link
                              aria-label="Github"
                              href="https://github.com/yash-kumar-Halder"
                              className="w-[30%] bg-linear-120 from-[#6d6d6d4f] to-[#0000003d] border border-[#242424] flex items-center justify-center rounded-full aspect-square cursor-pointer hover:-rotate-12 transition-all duration-150 hover:scale-105"
                          >
                  ...
                  <div className="order-1 sm:order-3 h-full px-8 py-2 pb-5 flex flex-col items-start justify-start bg-gray-600/20 rounded-md border border-transparent hover:border-gray-950/50 dark:hover:border-muted hover:scale-[1.02] transition-all duration-200 ">
                      ...
                      <div className="w-full h-full">
                          ...
                          <p className="text-xs pb-4  mt-2 md:mt-0 md:text-sm text-gray-600 font-medium dark:text-gray-400 ">
                              Completed Higher Secondary Education in 2024 from
                              Jyotrimoy Basu Vocational Center, Vocational
                              Department, achieving an aggregate of 81.8%.
                          </p>
                      </div>
                  </div>
              </div>
